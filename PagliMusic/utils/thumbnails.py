...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("PagliMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("PagliMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("PagliMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("PagliMusic/assets/play_icons.png")
