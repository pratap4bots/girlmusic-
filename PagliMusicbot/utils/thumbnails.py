...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("PagliMusicbot/assets/font2.ttf", 30)
        font = ImageFont.truetype("PagliMusicbot/assets/font.ttf", 30)
        title_font = ImageFont.truetype("PagliMusicbot/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("PagliMusicbot/assets/play_icons.png")
