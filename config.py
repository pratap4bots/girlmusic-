...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/pratap4bots/girlmusic",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+hFO7JXtvapVlZGM1")

# Set this to True if you want the assistant to automatically leave chats after an interval
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", False))

# make your bots privacy from telegra.ph and put your url here 
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-PagliMusic-08-14")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/fa1xas.jpg"
)
PING_IMG_URL = getenv(
